			...
			echo wp_kses_post(
				'<div class="notice notice-error is-dismissible wcst-wcshipping-migration-notice"><p style="margin-bottom:0px">' .
				 sprintf(
					...
					__( 'WooCommerce Shipping & Tax is splitting into two dedicated extensions: WooCommerce Shipping and WooCommerce Tax. To minimize disruption, your settings and data will be carried over to the new extensions when you upgrade. <a href="%s">Learn more about this change.</a>', 'woocommerce-services' ),
					'https://wordpress.org/plugins/woocommerce-services/'
				)  .
				'</p>
				<button style="color:#3858E9;margin: 12px 0;width: 106px;height: 36px;border: 1px solid #3858E9;padding: 11.5px, 12px, 11.5px, 12px;border-radius: 2px;background-color:#fff;">Upgrade now</button>
				</div>'
		)	;
		}
	}
