...
class WC_Connect_TaxJar_Integration {
	 ...
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L913
	 *
	 * @return array
	 */
	 ...
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L475
	 *
	 * @return void
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L539
	 *
	 * @return void
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L586
	 *
	 * @return array
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L610
	 *
	 * @return array
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L629
	 *
	 * @return array
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L679
	 *
	 * @return array
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L732
	 *
	 * @return array
	 */
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L770
	 *
	 * @return array
	 */
	...
	/**
	 * Determine if the given country and/or state falls within the Tax Nexus.
	 *
	 * Port of WC_Taxjar_Nexus::has_nexus_check()
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/d66a1ec/includes/class-wc-taxjar-nexus.php#L51
	 *
	...
	public function calculate_tax( $options = array() ) {
		...
		if ( ! $this->has_nexus_check( $to_country, $to_state ) ) {
	 ...
	 *
	 * Unchanged from the TaxJar plugin.
	 * See: https://github.com/taxjar/taxjar-woocommerce-plugin/blob/4250146/includes/class-wc-taxjar-integration.php#L395
	 *
	 * @return void
	 */
