...
if ( ! class_exists( 'WC_Connect_Shipping_Label' ) ) {
	...
	class WC_Connect_Shipping_Label {
		...
		protected function get_form_data( WC_Order $order ) {
			...
			$end_shipper       = $this->format_address_for_api( $this->settings_store->get_end_shipper_address() );
			...
			$form_data = compact( 'is_packed', 'selected_packages', 'origin', 'destination', 'origin_normalized', 'destination_normalized', 'end_shipper' );
