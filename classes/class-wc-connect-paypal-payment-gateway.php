...
/**
 * Class that handles PPEC payment method.
 *
 * @extends WC_Connect_Paypal_Payment_Gateway
 *
 * @since 4.0.0
 */
class WC_Connect_Paypal_Payment_Gateway extends WC_Payment_Gateway {
	/**
	 * Notices (array)
	 * @var array
	 */
	...
	public function __construct() {
		$this->id                   = 'wcs_ppec';
		$this->method_title         = __( 'PayPal Express Checkout via WooCommerce Services', 'woocommerce-services' );
		/* translators: link */
		// $this->method_description   = sprintf( __( 'All other general Stripe settings can be adjusted <a href="%s">here</a>.', 'woocommerce-services' ), admin_url( 'admin.php?page=wc-settings&tab=checkout&section=stripe' ) );
