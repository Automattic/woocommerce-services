	...
	public function get() {
		...
		return array(
			...
			'formMeta'     => array(
				...
				'master_user_name'        => $connection_owner->display_name,
				'master_user_login'       => $connection_owner->user_login,
				'master_user_wpcom_login' => $connection_owner_wpcom_data['login'],
				'master_user_email'       => $connection_owner_wpcom_data['email'],
