...
class WP_Test_WC_Connect_NUX extends WC_Unit_Test_Case {
	...
	public function test_get_banner_type_to_display_no_jp_cxn() {
		...
		// after going through connection
		$this->assertEquals( WC_Connect_Nux::get_banner_type_to_display( array(
	...
	public function test_get_banner_type_to_display_with_jp_cxn() {
		// Jetpack is already connected
