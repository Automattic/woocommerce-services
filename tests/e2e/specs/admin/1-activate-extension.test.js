...
describe( 'Store admin can login and make sure WooCommerce Tax extension is activated', () => {
	it( 'Can activate WooCommerce Tax extension if it is deactivated' , async () => {
