...
$i18nStrings = array(
	...
	"****%(digits)s" => __( "****%(digits)s", "woocommerce-services" ),
	...
	"Add another credit card" => __( "Add another credit card", "woocommerce-services" ),
	...
	"American Express" => __( "American Express", "woocommerce-services" ),
	...
	"Credit card" => __( "Credit card", "woocommerce-services" ),
	...
	"Discover" => __( "Discover", "woocommerce-services" ),
	...
	"Expires %(date)s" => _x( "Expires %(date)s", "date is of the form MM/YY", "woocommerce-services" ),
	...
	"MasterCard" => __( "MasterCard", "woocommerce-services" ),
	...
	"PayPal" => __( "PayPal", "woocommerce-services" ),
	...
	"Use your credit card on file to pay for the labels you print or add a new one." => __( "Use your credit card on file to pay for the labels you print or add a new one.", "woocommerce-services" ),
	"VISA" => __( "VISA", "woocommerce-services" ),
