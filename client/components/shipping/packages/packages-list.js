	...
	render: function() {
		return (
			<FormFieldset className="wcc-shipping-packages-list">
				...
				<PackagesListItem type="mail" name="Large padded envelope" dimensions="14 x 7 x .25 in" />
				<PackagesListItem type="flip-horizontal" name="Bike box" dimensions="34 x 12 x 9.75 in" />
			</FormFieldset>
		);
	}
} );
