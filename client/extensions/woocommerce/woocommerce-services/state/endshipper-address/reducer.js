...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_INIT_FORM ] = (
	state,
...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_SET_FORM_DATA_VALUE ] = ( state, { key, value } ) => {
...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_SET_FORM_META_PROPERTY ] = ( state, { key, value } ) => {
	return {
		...state,
		meta: {
			...state.meta,
...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_RESTORE_PRISTINE ] = state => {
...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_OPEN_ADD_CARD_DIALOG ] = state => {
	return {
		...state,
		addCardDialog: true,
	};
...
reducers[ WOOCOMMERCE_SERVICES_ENDSHIPPER_CLOSE_ADD_CARD_DIALOG ] = state => {
	return {
		...state,
		addCardDialog: null,
	};
